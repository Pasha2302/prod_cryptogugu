...
from app.models import Coin, PromotedCoins, BaseCoin, SiteSettings, ReclamBanner, ReclamBannerPopUp, BannerImagePopUp, \
    Airdrops
...
class CoinAdmin(admin.ModelAdmin):
    form = CoinAdminForm
    readonly_fields = ('price_change_percentage',)
