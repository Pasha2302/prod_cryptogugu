...
class SettingsManager:
    ...
    def get_filter_item(self):
        filter_item = {
            ...
            'item_sub': [
                {'active': False, 'title': obj_chain.name, 'slug': obj_chain.slug} for obj_chain in Chain.objects.all()
                # {'active': False, 'title': 'WAX', 'slug': 'wax'},
                # {'active': False, 'title': 'SOLANA', 'slug': 'sol'},
                # {'active': False, 'title': 'Binance Smart slug', 'symbol': 'bsc'},
                # {'active': False, 'title': 'Tron', 'slug': 'tron'},
            ],
        ...
        for item_sub in filter_item['item_sub']:
            if item_sub['slug'] == str(self.user_settings_obj.item_sub_symbol):
